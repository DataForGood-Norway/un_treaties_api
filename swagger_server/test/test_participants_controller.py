...
class TestParticipantsController(BaseTestCase):
    ...
    def test_get_participant_by_id(self):
        ...
        response = self.client.open(
            "/api/participants/{participantId}".format(participantId=789), method="GET"
        )
    ...
    def test_get_participant_by_name(self):
        ...
        """
        response = self.client.open(
            "/api/participants/name/{name}".format(name="name_example"), method="GET"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_get_participants(self):
        ...
        """
        response = self.client.open("/api/participants", method="GET")
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_participants_regions(self):
        ...
        """
        response = self.client.open("/api/participants/regions", method="GET")
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
